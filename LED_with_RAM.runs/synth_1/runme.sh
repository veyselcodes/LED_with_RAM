...
HD_PWD='C:/Users/recep/LED_with_RAM/LED_with_RAM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LED_with_RAM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LED_with_RAM.tcl
