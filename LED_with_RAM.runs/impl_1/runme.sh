...
HD_PWD='C:/Users/recep/LED_with_RAM/LED_with_RAM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log LED_with_RAM.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source LED_with_RAM.tcl -notrace
